...
// 🧠 Meeting Notes AI Parser Demo - Test the NLP functionality here!
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {features.map((feature, index) => (
            <div key={`feature-${index}`} className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {extractionExamples.map((category, index) => (
              <div key={`extraction-${index}`} className="space-y-4">
                <div className="flex items-center gap-3 mb-4">
                  <div className={`p-2 rounded-lg ${category.bgClass}`}>
                    <category.icon className={`h-5 w-5 ${category.textClass}`} />
                  </div>
                ...
                <div className="space-y-2">
                  {category.examples.map((example, exampleIndex) => (
                    <div key={`example-${exampleIndex}`} className="flex items-start gap-2">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {sampleMeetingNotes.map((note, index) => (
              <div key={`note-${index}`} className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {createdTasks.map((task, index) => (
                <div key={`task-${index}`} className="border border-gray-200 rounded-lg p-4">
